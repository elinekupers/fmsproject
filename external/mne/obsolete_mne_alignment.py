...
from mne import io
from mne import read_raw_kit

import os


mne.channels.read_dig_montage(hsp=None, hpi=None, elp=None, point_names=None, unit='auto', fif=None, egi=None, transform=True, dev_head_t=False)[source]
...
Marketplace
Explore
 @elinekupers Sign out
63
639 466 mne-tools/mne-python
 Code  Issues 219  Pull requests 25  Projects 2  Wiki  Insights
mne-python/tutorials/plot_source_alignment.py
0311412  on Nov 15, 2017
@larsoner larsoner MRG: Add colors to sphere ConductorModel (#4725)
@larsoner @jaeilepp
     
208 lines (189 sloc)  8.88 KB
# -*- coding: utf-8 -*-
"""
