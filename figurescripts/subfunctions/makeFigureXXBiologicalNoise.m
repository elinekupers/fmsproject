function makeFigureXXBiologicalNoise(varargin)
% This is a function to make a supplemental figure for the manuscript:
...
%
% Example 1:
%  makeFigureXXBiologicalNoise('subjectsToPlot', 1, 'plotMeanSubject', false, 'saveFig', true)
% Example 2:
%  makeFigureXXBiologicalNoise('subjectsToPlot', 12, 'plotMeanSubject', false, 'saveFig', true)
% Example 3:
%  makeFigureXXBiologicalNoise('subjectsToPlot', 1:12, 'plotMeanSubject', true, 'saveFig', true)
%
