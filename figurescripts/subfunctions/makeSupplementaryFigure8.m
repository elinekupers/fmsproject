function makeSupplementaryFigure8(varargin)
% This is a function to make Supplementary Figure 8 from the manuscript:
...
%
% Example 1:
%  makeSupplementaryFigure8('subjectsToPlot', 1, 'plotMeanSubject', false, 'saveFig', true)
% Example 2:
%  makeSupplementaryFigure8('subjectsToPlot', 12, 'plotMeanSubject', false, 'saveFig', true)
% Example 3:
%  makeSupplementaryFigure8('subjectsToPlot', 1:12, 'plotMeanSubject', true, 'saveFig', true)
%
...
for s = subjectsToPlot
    ...
    if saveFig
        ...
        figurewrite(fullfile(figureDir, sprintf('SupplFigure8_varyEccenPredictions_%s_%d_%s_highResFlag%d_S%d_cumulative_normalized', area, contourPercentile, headmodelType, highResSurf, s)),0,[1 300],'.',1);
        set(0, 'currentfigure', fH2);
        figurewrite(fullfile(figureDir, sprintf('SupplFigure8_Contour_Synchr_varyEccenPredictions_%s_%d_%s_highResFlag%d_cumulative_normalized', area,contourPercentile, headmodelType, highResSurf)),[],0,'.',1);
        set(0, 'currentfigure', fH3);
        figurewrite(fullfile(figureDir, sprintf('SupplFigure8_Contour_Asynchr_varyEccenPredictions_%s_%d_%s_highResFlag%d_cumulative_normalized', area,contourPercentile, headmodelType, highResSurf)),[],0,'.',1);
    end
end
...
if plotMeanSubject
    ...
    if saveFig
        ...
        figurewrite(fullfile(figureDir, sprintf('SupplFigure8_varyEccenPredictions_%s_%d_%s_highResFlag%d_AVERAGE_cumulative_normalized', area,contourPercentile, headmodelType, highResSurf)),0,[1 300],'.',1);
        set(0, 'currentfigure', fH5);
        figurewrite(fullfile(figureDir, sprintf('SupplFigure8_Contour_Synchr_varyEccenPredictions_%s_%d_%s_highResFlag%d_AVERAGE_cumulative_normalized', area,contourPercentile, headmodelType, highResSurf)),[],0,'.',1);
        set(0, 'currentfigure', fH6);
        figurewrite(fullfile(figureDir, sprintf('SupplFigure8_Contour_Asynchr_varyEccenPredictions_%s_%d_%s_highResFlag%d_AVERAGE_cumulative_normalized', area,contourPercentile, headmodelType, highResSurf)),[],0,'.',1);
    end
