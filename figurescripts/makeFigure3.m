function makeFigure3(subjectsToPlot)
...
for s = subjectsToPlot
    ...
    fig_ttl      = {sprintf('Figure3_Observed_MEG_Data_incohSpectrum%d_contour%2.1f', useSLIncohSpectrum, contourPercentile), sprintf('Figure3_Sl_and_Broadband_Compared_incohSpectrum%d_contour%2.1f', useSLIncohSpectrum, contourPercentile)};
...
if doSOIcomparison
    ...
    if saveFigures
        hgexport(gcf,fullfile(figureDir,'Figure3_SOI_boxplot'))
    end
